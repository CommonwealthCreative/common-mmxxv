<div data-w-id="f054164c-46ae-9b22-9ce2-ed99c490d194" style="opacity:0" class="_1300 sectionstart" id="pricing">
    ...
    <p class="big" style="margin-bottom:10px;">Subscribe for unlimited access to every service we offer. Fixed cost. No contracts. Cancel or pause anytime. Kick off your membership with our <a href="/workbook" target="_blank" class="underline"><span class="">Brand Strategy Workbook,</span></a> where we&#x27;ll evaluate your brand + technology positioning, and define your KPIs. Get immediate access to your dashboard, submit unlimited requests, and receive deliverables every 48-72 hours.
      ...
      <div id="w-node-_2599bb22-7a1b-6a83-8ec2-59e174badc26-e7795935" class="w-layout-layout commonstack wf-layout-layout">
        <div class="w-layout-cell">
          <div data-w-id="2599bb22-7a1b-6a83-8ec2-59e174badc28" style="opacity:0" class="commoncard bgwhite">
            ...
            <p class="mid">Unlimited access to all services —<i>full-stack development +$499/project</i>. Perfect for organizations with an established brand who need design and content updates.</p>
            <div class="smalls">*Pause or Cancel Anytime. Military &amp; Non-Profit Discounts.</div>
            <a href="https://buy.stripe.com/14k4h2axrevC7kcbIR" target="_blank" class="button bgdark w-button">Start Membership<span class="fa after"></span></a>
        ...
        <div class="w-layout-cell">
          <div data-w-id="d58e2865-e975-e494-7590-64cc7dbe37bc" style="opacity:0" class="commoncard bgdark">
            ...
            <p class="mid">Full-stack design and development, unlimited access to everything. Ideal for those seeking a blend of design and development to build an impactful brand. </p>
            <div class="smalls">*Pause or Cancel Anytime. Military &amp; Non-Profit Discounts.</div>
            <a href="https://buy.stripe.com/5kAbJu9tn2MU5c4bIS" target="_blank" class="button bgwhite w-button">Start Membership<span class="fa after"></span></a>
