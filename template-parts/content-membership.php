  ...
  <section class="section-common hero">
    ...
    <div data-w-id="34239f0a-c1ca-2acf-c782-767626233dfb" style="opacity:0" class="_1300">
      <div class="commoncenter">
        <a href="#pricing" class="pills center bgcommon"><span class="fa"></span>Only 2 Memberships Available.</a>
        <h1 class="textwhite">Unlock <em class="textcommon">unlimited access</em> to full-stack design &amp; development.</h1>
        <div class="scripts withlove">made with <span class="fa middle textcommon"></span> in the commonwealth of virginia</div>
        <p class="mid textwhite">Built for founders, marketers, and enterprise teams, we're bringing you full-stack design &amp; development <strong>the way it should have been all along</strong>: one membership, every service, unlimited requests—delivered every 48–72 hours.</p>
        <a href="#pricing" class="button w-button bgwhite">Plans &amp; Pricing<span class="fa after"></span></a>
          ...
          <div data-w-id="f05169ee-178c-7301-722f-a74d6acb4b83" class="commoncard _2">
            ...
            <ul role="list" class="commonlist">
              <li>
                ...
                <a href="#" data-cal-link="hello.mattsmall/introduction-with-matt-small-commonwealth-creative" data-cal-namespace="" data-cal-config='{"layout":"month_view"}' class="pills textwhite">Security Audits</a>
              </li>
            </ul>
            <div>
